...
- **Lab**: [YouTube → Subtitles → Topics → timestamps + JSON summary pipeline](2026-02/docs/labs/week-3/youtube-subtitles-topics-json-pipeline.md)
- **Lab**: [Cost-tracking dashboard; compare prompt strategies via LangSmith](2026-02/docs/labs/week-3/cost-tracking-dashboard-langsmith.md)
