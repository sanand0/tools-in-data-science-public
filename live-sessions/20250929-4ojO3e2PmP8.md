...
**A8:** This happens if Git started tracking the `.env` file _before_ you added it to `.gitignore`. Even if it's ignored now, Git still remembers it was tracked.
